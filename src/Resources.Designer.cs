...
namespace FlowSynx.Plugins.Azure.Blobs {
    ...
    internal class Resources {
        ...
        /// <summary>
        ///   Looks up a localized string similar to The Azure Blob storage doesn&apos;t support create empty directory..
        /// </summary>
        internal static string AzureBlobStorageNotSupportCreatingEmptyDirectory {
            get {
                return ResourceManager.GetString("AzureBlobStorageNotSupportCreatingEmptyDirectory", resourceCulture);
            }
        }
        ...
        /// <summary>
        ///   Looks up a localized string similar to Something wrong happened during processing existing file &apos;{0}&apos; on Azure Blob!.
        /// </summary>
        ...
        /// <summary>
        ///   Looks up a localized string similar to The entered path &apos;{0}&apos; could not be purged!.
        /// </summary>
        internal static string TheEnteredPathCouldNotBePurged {
            get {
                return ResourceManager.GetString("TheEnteredPathCouldNotBePurged", resourceCulture);
            }
        }
        
        /// <summary>
        ///   Looks up a localized string similar to The entered path &apos;{0}&apos; must be not root path!.
        /// </summary>
        internal static string TheEnteredPathMustBeNotRootPath {
            get {
                return ResourceManager.GetString("TheEnteredPathMustBeNotRootPath", resourceCulture);
            }
        }
